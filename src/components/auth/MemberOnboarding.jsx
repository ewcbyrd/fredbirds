                ...
                <CardContent sx={{ p: 4 }}>
                        ...
                        <Grid container spacing={3}>
                            ...
                            <Grid item xs={12}>
                                ...
                                <Typography
                                    ...
                                    sx={{ mb: 2 }}
                                >
                                    Choose what information is visible to other
                                    members in the directory and profiles.
                                </Typography>
                    ...
                    <Box sx={{ mt: 3, textAlign: 'center' }}>
                        <Typography variant="body2" color="text.secondary">
                            Your profile information will be used for club
                            communications. You can always update your privacy
