            ...
            try {
                ...
                await sendEmail({
                    ...
                    html: [
                        ...
                        `<li>Click <strong>&ldquo;Sign Up&rdquo;</strong> and create an account using this email address (<strong>${member.email}</strong>)</li>`,
                    ...
                    text: [
                        ...
                        `3. Click "Sign Up" and create an account using this email address (${member.email})`,
                        "4. Once logged in, you'll have full access to all member features",
                        '',
