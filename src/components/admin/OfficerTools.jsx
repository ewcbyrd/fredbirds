...
const OfficerTools = () => {
    ...
    const [manageAnnouncementsOpen, setManageAnnouncementsOpen] =
        useState(false);
                        ...
                        <Card>
                            <CardContent>
                                ...
                                <Typography
                                    ...
                                    sx={{ mb: 3 }}
                                >
                                    Create, edit, and manage club birding events
                                    and field trips.
                                </Typography>
                                <Button
                                    variant="contained"
                        ...
                        <Card>
                            <CardContent>
                                ...
                                <Typography
                                    ...
                                    sx={{ mb: 3 }}
                                >
                                    Post important news and updates for club
                                    members.
                                </Typography>
                                <Button
                                    variant="contained"
                                    ...
                                    fullWidth
                                    onClick={() =>
                                        setManageAnnouncementsOpen(true)
                                    }
                                >
                        ...
                        <Card>
                            <CardContent>
                                ...
                                <Typography
                                    ...
                                    sx={{ mb: 3 }}
                                >
                                    Generate reports on club activities and
                                    participation.
                                </Typography>
                                <Button
                                    variant="contained"
