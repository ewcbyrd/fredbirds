...
const EventDetailsDialog = ({ open, onClose, event, onEventUpdated }) => {
    ...
    const loadEventData = async () => {
        try {
            ...
            if (user?.email) {
                const isAttending = attendeeList.some(
    ...
    const locations =
        ...
        (currentEvent.lat && currentEvent.lon
            ? [
                  {
                      name: 'Event Location',
                ...
                <Box sx={{ pr: { xs: 4, md: 2 }, width: '100%' }}>
                    ...
                    >
                        ...
                        <Chip
                            ...
                            sx={{
                                bgcolor:
                                    currentEvent.isClubEvent === false
                                ...
                                border:
                                    currentEvent.isClubEvent === false
                                        ...
                                        : '1px solid rgba(44, 95, 45, 0.1)'
                            }}
                        />
                        <Chip
                            label={
                                currentEvent.isClubEvent === false
                                    ? 'Private / Non-Club Event'
                                    : 'Official Club Event'
                            }
                            size="small"
                            sx={{
                        ...
                        <Box
                            sx={{
                                ...
                                '& a': {
                                    ...
                                    fontWeight: 600,
                                    borderBottom:
                                        '2px solid rgba(44, 95, 45, 0.2)',
                                    transition: 'all 0.2s',
                                    '&:hover': {
                                        borderBottomColor: 'primary.main',
                                        bgcolor: 'rgba(44, 95, 45, 0.05)'
                                    }
                                }
                            }}
                        >
                            <ReactMarkdown>
                                {currentEvent.details || 'No details provided.'}
                            </ReactMarkdown>
                        </Box>

                        {/* Trip Reports Link Card */}
                        {(currentEvent.ebirdTripUrl ||
                            currentEvent.eBirdTripUrl ||
                            currentEvent.ebird_trip_url) && (
                            <Paper
                                elevation={0}
                                sx={{
                                    mt: 6,
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        Species list and photos from this outing
                                        are available.
                                    </Typography>
                                </Box>
                                <Button
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <Box>
                                            ...
                                            >
                                                {currentEvent.tripLeader.name ||
                                                    `${currentEvent.tripLeader.firstName} ${currentEvent.tripLeader.lastName}`}
                                            </Typography>
                                        </Box>
                                    </Box>
                                </Paper>
                            ...
                            {isAuthenticated ? (
                                <Button
                                    ...
                                    sx={{
                                        ...
                                        fontSize: '1rem',
                                        fontWeight: 600,
                                        boxShadow: currentUserAttending
                                            ? 'none'
                                            : '0 8px 20px rgba(44, 95, 45, 0.25)',
                                        '&:hover': {
                                            boxShadow: currentUserAttending
                                                ? 'none'
                                                : '0 12px 24px rgba(44, 95, 45, 0.35)'
                                        }
                                    }}
                                >
                                    {loadingAction
                                        ...
                                        {attendees.map((attendee, i) => (
                                            ...
                                            >
                                                <Avatar
                                                    ...
                                                    src={
                                                        attendee.picture ||
                                                        `https://ui-avatars.com/api/?name=${attendee.firstName}+${attendee.lastName}&background=random`
                                                    }
                                                />
                                            </Tooltip>
                                        ))}
                ...
                <EventFormModal
                    ...
                    event={{
                        ...
                        start: currentEvent.originalStart || currentEvent.start,
                            ...
                            currentEvent.originalEnd !== undefined
                                ? currentEvent.originalEnd
                                : currentEvent.end
                    }}
                    onSuccess={() => {
