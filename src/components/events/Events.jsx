...
export default function Events({
    ...
    if (singleEvent) {
        ...
        if (upcomingEvents.length === 0)
            return <Typography>No upcoming events</Typography>;
                                ...
                                >
                                    ...
                                    <Box
                                        sx={{
                                            minWidth: 70,
                                            textAlign: 'center',
                                            bgcolor: event.resource?.cancelled
                                                ? 'error.main'
                                                : event.resource
                                                        ?.isClubEvent === false
                                                  ? 'info.main'
            ...
            >
                <Calendar
                    ...
                    eventPropGetter={(event) => ({
                        style: {
                            backgroundColor: event.resource?.cancelled
                                ? theme.palette.error.main
                                : event.resource?.isClubEvent === false
