            ...
            {sightings && sightings.length > 0 ? (
                <>
                    <Grid container spacing={3}>
                        {displayedSightings.map((s) => {
                            const groupedSightings = groupByLocality(
                                s.individualSightings || []
                            );
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            >
                                                {openIds.has(s.id || s.name)
                                                    ? 'Hide Details'
                                                    : 'View Reports'}
                                            </Button>

                                            <Collapse
                                                in={openIds.has(s.id || s.name)}
                                            >
                                                <Box
                                                    sx={{
                                                        mt: 2,
                    ...
                    {hasMore && (
                        ...
                        >
                            ...
                            >
                                Load More Sightings (
                                {sightings.length - displayLimit} remaining)
                            </Button>
                        </Box>
                    )}
                </>
                ...
                >
                    ...
                    <Typography variant="body2" color="text.secondary">
                        Try adjusting availability settings or checking back
                        later.
                    </Typography>
                </Box>
            )}
