...
export default function MemberDashboard() {
    ...
    const firstName =
        memberProfile?.first || user?.name?.split(' ')[0] || 'Member';
        ...
        <PageContainer>
            ...
            {loading ? (
                ...
                >
                    <Avatar
                        src={
                            getPictureUrl(memberProfile?.picture) ||
                            user?.picture
                        }
                        alt={firstName}
                        sx={{
                        ...
                        <Card
                            ...
                            sx={{
                                ...
                                '&:hover': {
                                    ...
                                    boxShadow:
                                        '0 12px 28px rgba(91, 155, 213, 0.2)',
                        ...
                        <Card
                            ...
                            sx={{
                                ...
                                '&:hover': {
                                    transform: 'translateY(-6px)',
                                    boxShadow:
                                        '0 12px 28px rgba(193, 120, 23, 0.2)',
                    ...
                    {loading ? (
                        ...
                        <Card
                            sx={{
                                ...
                                '&:hover': {
                                    boxShadow:
                                        '0 10px 32px rgba(45, 80, 22, 0.12)',
                                                        ...
                                                        {nextEvent.locations
                                                            ...
                                                            ? nextEvent
                                                              ...
                                                              nextEvent
                                                                  .locations[0]
                                                                  .address ||
                                                              'View map for location details'
                                                            : 'Location on map'}
                                                        {nextEvent.locations
                                                            ?.length > 1 &&
                                                            ` (+${nextEvent.locations.length - 1} more locations)`}
                                                    </Typography>
                                                </Box>
                                            )}
                                        </Stack>
                ...
                <Grid item xs={12} md={5} lg={4}>
                    ...
                    <Card
                        sx={{
                            ...
                            '&:hover': {
                                boxShadow:
                                    '0 10px 32px rgba(193, 120, 23, 0.12)'
                            }
                        }}
                    >
                        <CardContent sx={{ p: 0 }}>
