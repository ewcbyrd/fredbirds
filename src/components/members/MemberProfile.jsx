...
const MemberProfile = () => {
    ...
    const breadcrumbItems = [
        ...
        {
            label: `${memberData?.first} ${memberData?.last}`,
                ...
                <CardContent sx={{ p: 4 }}>
                    ...
                    <Grid container spacing={3} sx={{ mb: 4 }}>
                        ...
                        <Grid item xs={12} md={8}>
                            ...
                            <List dense>
                                {(memberData?.showEmail === true ||
                                    isOwnProfile(user, memberData)) && (
                                    <ListItem>
                                        <ListItemIcon>
                                            <Email color="action" />
                                        </ListItemIcon>
                    ...
                    <>
                        ...
                        {loadingEvents ? (
                            ...
                            <>
                                ...
                                {Math.ceil(
                                    memberEvents.length / eventsPerPage
                                ) > 1 && (
                                    <Box
                                        sx={{
                                            display: 'flex',
