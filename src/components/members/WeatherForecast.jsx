    ...
    if (!weather) {
        ...
        if (eventDate && !isWithinForecastRange(eventDate)) {
            ...
            const daysUntilEvent = Math.ceil(
                (eventDateTime - now) / (1000 * 60 * 60 * 24)
            );
            ...
            if (daysUntilEvent > 5 && daysUntilEvent <= 14) {
                return (
                    <Box sx={{ mt: 2 }}>
                        ...
                        <Alert severity="info" size="small">
                            Weather forecast available up to 5 days in advance.
                        ...
                        <Grid item xs={9}>
                            ...
                            {weather.forecastTime &&
                                !weather.isCurrentWeather && (
                                    ...
                                    >
                                        Forecast for{' '}
                                        {weather.forecastTime.toLocaleDateString()}{' '}
                                        {weather.forecastTime.toLocaleTimeString(
                                            [],
                                            {
                                                hour: '2-digit',
                                                minute: '2-digit'
