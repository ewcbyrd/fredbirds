            ...
            <Card sx={{ mb: 3 }}>
                <CardContent>
                    ...
                    >
                        <Avatar
                            src={
                                getPictureUrl(memberData?.picture) ||
                                user.picture
                            }
                            alt={
                    ...
                    <Typography
                        ...
                        sx={{ mb: 2 }}
                    >
                        Choose what information is visible to other members in
                                    ...
                                    label={
                                        <Box>
                                            ...
                                            <Typography
                                                ...
                                                color="text.secondary"
                                            >
                                                Allow other members to see your
                                ...
                                <Grid container spacing={3}>
                                    <Grid item xs={12}>
                                        <TextField
                                            ...
                                            value={editEbirdUrl}
                                            onChange={(e) =>
                                                setEditEbirdUrl(e.target.value)
                                            }
                                    ...
                                    !memberData?.linkedin && (
                                        <Grid item xs={12}>
                                            ...
                                            >
                                                ...
                                                the edit button to add your
                                                eBird, Facebook, or LinkedIn
                                                profile.
                                            </Typography>
                                        </Grid>
                                    )}
