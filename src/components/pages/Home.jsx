...
import NearbySightings from '../sightings/NearbySightings';
        ...
        <Box>
            ...
            <Box
                sx={{
                    ...
                    '&::before': {
                        ...
                        bottom: 0,
                        background:
                            'radial-gradient(circle at 30% 50%, rgba(45, 80, 22, 0.2) 0%, transparent 70%)',
                        pointerEvents: 'none'
                    }
                }}
            >
                ...
                >
                    ...
                    >
                        Join bird enthusiasts of all skill levels in the greater
                        Fredericksburg, Virginia area. From beginners to
                        advanced birders, we share our passion for birds through
                        field trips, events, and community.
                    </Typography>
                </Box>
            </Box>
            ...
            <Box
                ...
                sx={{
                    ...
                    transform: quickLinksAnimation.isVisible
                        ? 'translateY(0)'
                        : 'translateY(30px)',
                        ...
                        <Grid item xs={12} sm={6} md={4} lg={2}>
                            <Card
                                ...
                                sx={{
                                    ...
                                    borderRadius: 4,
                                    boxShadow:
                                        '0 12px 35px rgba(45, 80, 22, 0.25)',
                                    transition:
                                    ...
                                    '&:hover': {
                                        ...
                                        boxShadow:
                                            '0 24px 50px rgba(45, 80, 22, 0.35)',
                        ...
                        <Grid item xs={12} sm={6} md={4} lg={2}>
                            <Card
                                ...
                                sx={{
                                    ...
                                    borderRadius: 4,
                                    boxShadow:
                                        '0 12px 35px rgba(91, 155, 213, 0.25)',
                                    transition:
                                        'all 0.4s cubic-bezier(0.175, 0.885, 0.32, 1.275)',
                                    border: '2px solid rgba(255,255,255,0.15)',
                                    position: 'relative',
                                    ...
                                    '&:hover': {
                                        transform:
                                            'translateY(-14px) scale(1.06)',
                                        boxShadow:
                                            '0 24px 50px rgba(91, 155, 213, 0.35)',
                                        border: '2px solid rgba(255,255,255,0.25)',
                                        '&::before': {
                                            opacity: 1
                                        }
                        ...
                        <Grid item xs={12} sm={6} md={4} lg={2}>
                            <Card
                                ...
                                sx={{
                                    ...
                                    borderRadius: 4,
                                    boxShadow:
                                        '0 12px 35px rgba(193, 120, 23, 0.25)',
                                    transition:
                                        'all 0.4s cubic-bezier(0.175, 0.885, 0.32, 1.275)',
                                    border: '2px solid rgba(255,255,255,0.15)',
                                    position: 'relative',
                                    ...
                                    '&:hover': {
                                        transform:
                                            'translateY(-14px) scale(1.06)',
                                        boxShadow:
                                            '0 24px 50px rgba(193, 120, 23, 0.35)',
                                        border: '2px solid rgba(255,255,255,0.25)',
                                        '&::before': {
                                            opacity: 1
                                        }
                            ...
                            <Card
                                ...
                                sx={{
                                    ...
                                    '&:hover': {
                                        ...
                                        boxShadow:
                                            '0 16px 35px rgba(139, 111, 71, 0.28)',
                                        opacity: 1,
                        ...
                        <Grid item xs={12} sm={6} md={4} lg={2}>
                            <Card
                                ...
                                sx={{
                                    ...
                                    borderRadius: 3,
                                    boxShadow:
                                        '0 8px 25px rgba(44, 120, 115, 0.2)',
                                    transition:
                                        'all 0.3s cubic-bezier(0.4, 0, 0.2, 1)',
                                    border: '1px solid rgba(255,255,255,0.12)',
                                    opacity: 0.95,
                                    '&:hover': {
                                        transform: 'translateY(-8px)',
                                        boxShadow:
                                            '0 16px 35px rgba(44, 120, 115, 0.28)',
                                        opacity: 1,
                                        border: '1px solid rgba(255,255,255,0.18)'
                                    }
                                }}
                            ...
                            <Grid item xs={12} sm={6} md={4} lg={2}>
                                <Card
                                    ...
                                    sx={{
                                        ...
                                        borderRadius: 3,
                                        boxShadow:
                                            '0 8px 25px rgba(107, 142, 111, 0.2)',
                                        transition:
                                            'all 0.3s cubic-bezier(0.4, 0, 0.2, 1)',
                                        border: '1px solid rgba(255,255,255,0.12)',
                                        opacity: 0.95,
                                        '&:hover': {
                                            transform: 'translateY(-8px)',
                                            boxShadow:
                                                '0 16px 35px rgba(107, 142, 111, 0.28)',
                                            opacity: 1,
                                            border: '1px solid rgba(255,255,255,0.18)'
                                        }
                                    }}
            ...
            <Box
                ...
                sx={{
                    ...
                    transform: announcementsAnimation.isVisible
                        ? 'translateY(0)'
                        : 'translateY(30px)',
                    transition: 'all 0.8s ease-out',
            ...
            <Box
                ...
                sx={{
                    ...
                    transform: eventsAnimation.isVisible
                        ? 'translateY(0)'
                        : 'translateY(30px)',
            ...
            <Box
                ...
                sx={{
                    ...
                    transform: sightingsAnimation.isVisible
                        ? 'translateY(0)'
                        : 'translateY(30px)',
                    transition: 'all 0.8s ease-out 0.2s',
                    position: 'relative',
