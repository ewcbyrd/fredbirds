...
export default async function handler(req, res) {
    ...
    try {
        ...
        if (member) {
            ...
            // Check if member is pending approval or inactive
            if (
                ...
                console.log(
                    'Member found but pending/inactive, assigning pending role'
                );
                return res.status(200).json({
                    role: 'pending',
                    user: {
        ...
        // No member record found — return public role
        // User must register via the Join form to become a member
        console.log('No member record found, returning public role');
        return res.status(200).json({
            role: 'public',
            user: {
                email: email
